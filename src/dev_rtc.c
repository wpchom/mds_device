...
{
    return (MDS_DevModuleInit((MDS_DevModule_t *)rtc, name, (const MDS_DevDriver_t *)driver,
                              handle, init));
}
...
void DEV_RTC_TimerCallback(DEV_RTC_Timer_t *timer,
                           void (*callback)(DEV_RTC_Timer_t *, MDS_Arg_t *), MDS_Arg_t *arg)
{
...
MDS_Err_t DEV_RTC_TimerStop(DEV_RTC_Timer_t *timer)
{
    ...
    return (timer->mount->driver->timer(timer, MDS_TIMEOUT_NO_WAIT));
}
...
void DEV_RTC_AlarmCallback(DEV_RTC_Alarm_t *alarm,
                           void (*callback)(DEV_RTC_Alarm_t *, MDS_Arg_t *), MDS_Arg_t *arg)
{
